...
\documentclass[]{deedy-resume-chloedorst}
\usepackage{expl3}
...
Principal Cellist \\
\sectionsep
\descript{Service Learning Symposium}
\location{Missouri S\&T}
Invited Speaker \\
\sectionsep
...
\descript{Missouri S\&T | Engineering Communications}
\location{August 2019 - present | Rolla, MO}
\begin{tightemize}
	\item Evaluated student writing for conformance to class expectations and basic writing conventions
	\item Communicated with course professor to understand expectations for assignments
	\item Coordinated with teaching assistant to return student material in a timely manner
	\item Established and maintained personal time table for grading assignments
\end{tightemize}
\sectionsep
\sectionsep
\runsubsection{Cello Instructor} \\ 
\descript{Kaleidoscope Discovery Center, Self Employed}
